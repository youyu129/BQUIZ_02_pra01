...
<div class="typeContainer">
    ...
    <div class="type" id="type2">菸害防制</div>
    <div class="type" id="type3">癌症防治</div>
    <div class="type" id="type4">慢性病防治</div>
</div>
<div class="container">
    <div class="text" id="text1">健康新知
    ...
    <div class="text" id="text2">菸害防制</div>
    <div class="text" id="text3">癌症防治</div>
    <div class="text" id="text4">慢性病防治</div>
</div>
