...
<div style="margin-bottom: 10px;">目前位置：首頁>分類網誌><span id="po_name"></span></div>

<div class="container flex">
    <div class="typeContainer">
        <div class="type nav1" id="type1">健康新知</div>
        <div class="type nav2" id="type2">菸害防制</div>
        <div class="type nav3" id="type3">癌症防治</div>
        <div class="type nav4" id="type4">慢性病防治</div>
    </div>
    <div class="textContainer">
        <div class="text" id="text1" style="display: block;">
            <h2>健康新知</h2>
            <pre>
<a href="#">缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%(一)</a>
<a href="#">缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%(二)</a>
<div>
資料來源： 行政院衛生署國民健康局
發佈日期： 2012 / 10 / 07
...
第三十三條　　本法所定罰則，除第二十五條規定由中央主管機關處罰外，由直轄市、縣（市）主管機關處罰之。
    ...
    <div class="text" id="text3">
        <h2>癌症防治</h2>
        <pre>
            <a href="#">降低罹癌風險 建構健康生活型態(一)</a>
            <a href="#">降低罹癌風險 建構健康生活型態(二)</a>
...
上稿日期：2010/1/20
    ...
    <div class="text" id="text4">
        <h2>慢性病防治</h2>
        <pre>
            <a href="#">長期憋尿 泌尿系統問題多(一)</a>
            <a href="#">長期憋尿 泌尿系統問題多(二)</a>
資料來源：中央健康保險局雙月刊第98期
上稿日期：2012/08/10
文／游小雯
