...
INSERT INTO `news` (`id`, `title`, `text`, `sh`, `likes`, `type`) VALUES
...
(1, '問題一：你最常做什麼運動來促進健康體能呢?', 0, '5'),
(2, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, '2'),
